...
Files: macbook.glb [629.72KB] > D:\macbook-landing-page-clone\public\models\macbook-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel(props) {
  ...
  const { texture, color } = useMackbookStore()

  const video = useVideoTexture(texture)

  useEffect(() => {
    scene.traverse(child => {
      if(child.isMesh) {
        if(!noChangeParts.includes(child.names)) {
